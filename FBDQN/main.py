...
saver = tf.train.import_meta_graph('./flappy_bird_dqn-4030000.meta')
...
while True:
    ...
    # Generate data for performance analyse
    if reward == 1:  # if pass the pipes
        score += 1
        print(score)
    elif reward == -1:  # if fail to pass the pipes
        print(score)
        score = 0
        break
